...
\textbf{SAS xCBS Hackathon Season 4} - ML for Fundraising Campaigns\hfill October 2024
\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, parsep=0pt]
...
\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item \textit{Machine Learning Specialization} - Issued by: DeepLearning.AI and Stanford University \hfill August 2024
